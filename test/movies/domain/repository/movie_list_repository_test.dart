...
class MovieListDataSourceTest extends Mock implements MovieListDataSource {}

@GenerateMocks([MovieListDataSourceTest])
void main() {
  const page = 2;
  final movieList = [
  ...
  late MockMovieListDataSourceTest mockDataSource;
  late MockNetworkInfoTest mockNetworkInfo;

  setUp(() {
    mockDataSource = MockMovieListDataSourceTest();
    mockNetworkInfo = MockNetworkInfoTest();
    repository = MovieListRepositoryImpl(
        datasource: mockDataSource, info: mockNetworkInfo);
  });
