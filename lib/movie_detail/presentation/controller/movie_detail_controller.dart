...
class MovieDetailController extends GetxController {
  MovieDetailUsecase usecase;

  MovieDetailController({required this.usecase});

  final RxList<Cast> _data1 = (List<Cast>.of([])).obs;
  final RxList<Video> _data2 = (List<Video>.of([])).obs;
  final Rx<AbstractMovieDetail?> _detail = Rx(null);

  // ignore: invalid_use_of_protected_member
  List<Cast> get data1 => _data1.value;
  // ignore: invalid_use_of_protected_member
  List<Video> get data2 => _data2.value;
  AbstractMovieDetail? get detail => _detail.value;
